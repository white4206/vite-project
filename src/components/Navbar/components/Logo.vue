<template>
    <div class="logo">
        <svg t="1689566178453" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
            ...
            <path d="M681.4 786H149.8s-53.2-1.1-53.2-86.2h637.9c0.1 85.1-53.1 86.2-53.1 86.2z" fill="#42A5F5" p-id="2191">
            </path>
            ...
            <path d="M719.8 616.5l19.4 39.3 43.3 6.3-31.3 30.6 7.4 43.1-38.8-20.4-38.8 20.4 7.4-43.1-31.4-30.6 43.4-6.3z"
